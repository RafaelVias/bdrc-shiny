...
This Shiny application can be used to generate a discharge rating curve from paired observations of water elevation (stage) and discharge. 
<br /> 
To start, the data must be uploaded.
